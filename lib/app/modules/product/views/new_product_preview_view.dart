...
class NewProductPreviewView extends StatefulWidget {
  const NewProductPreviewView({Key? key}) : super(key: key);

  @override
  State<NewProductPreviewView> createState() => _NewProductPreviewViewState();
}

class _NewProductPreviewViewState extends State<NewProductPreviewView> {
