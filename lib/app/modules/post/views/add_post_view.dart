            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    '${media.length}/${PostController.MAX_MEDIA_FILES}',
              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Recording... ${controller.recordingDuration.value}s / ${PostController.MAX_VIDEO_DURATION_SECONDS}s',
                      style: const TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 4),
                  Text(
                    '${controller.selectedMedia.length}/${PostController.MAX_MEDIA_FILES}',
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 10,
                      fontWeight: FontWeight.bold,
