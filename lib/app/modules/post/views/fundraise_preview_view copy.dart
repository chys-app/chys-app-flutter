...
class FundraisePreviewView extends StatefulWidget {
  const FundraisePreviewView({Key? key}) : super(key: key);

  @override
  State<FundraisePreviewView> createState() => _FundraisePreviewViewState();
}

class _FundraisePreviewViewState extends State<FundraisePreviewView>
  ...
  Widget _buildFundraiseInfo(Posts post) {
    if (post.goal == null && post.deadline == null) {
          ...
          if (post.deadline != null) ...[
            Row(
              children: [
                ...
                const SizedBox(width: 6),
                Text(
                  'Deadline: ${_formatDeadline(post.deadline!)}',
                  style: const TextStyle(
                    color: Colors.white70,
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      // Description with love icon
                                      Row(
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          // Love icon on the left
                                          GestureDetector(
                                            onTap: () {
                                      ...
                                      // Fundraise info (goal and deadline)
                                      _buildFundraiseInfo(post),
                                      const SizedBox(height: 16),
                                      // Stats
                                      Obx(() => Row(
                                            children: [
